...
/* Products */
const PRODUCTS = [
  { name: "Cheeseburger", price: 150, cat: "Burger" },
  { name: "Double Cheeseburger", price: 250, cat: "Burger" },
  { name: "Chicken Burger", price: 220, cat: "Burger" },
  { name: "Veggie Burger", price: 200, cat: "Burger" },
  { name: "Pommes", price: 80, cat: "Beilagen" },
  { name: "Onion Rings", price: 100, cat: "Beilagen" },
  { name: "Chili Cheese Fries", price: 140, cat: "Beilagen" },
  { name: "Cola", price: 60, cat: "Getränke" },
  { name: "Wasser", price: 40, cat: "Getränke" },
  { name: "Milkshake", price: 120, cat: "Getränke" },
  { name: "Donut", price: 70, cat: "Süßes" },
  { name: "Cookie", price: 50, cat: "Süßes" },
  { name: "Menü (Burger+Pommes+Drink)", price: 300, cat: "Menü" }
];
