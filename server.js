...
const DEFAULT_PRODUCTS = [
  ...
  { id:"orange_o_tang",    name:"Orange O Tang",     price:8,  cat:"Getränke", icon:"orang_o_tang.png",     ekPrice:2 },
  { id:"mexi_coke_spicy",  name:"Mexi-Coke Spicy",   price:12, cat:"Getränke", icon:"mexi_coke_spicy.png",  ekPrice:4 },
  { id:"junk_energy",      name:"Junk Energy",        price:14, cat:"Getränke", icon:"junk_energy.png",      ekPrice:5 },
  { id:"juice_apple",      name:"Apfelsaft",          price:10, cat:"Getränke", icon:"Juice_Apple.png",      ekPrice:3 },
  { id:"juice_orange",     name:"Orangensaft",        price:10, cat:"Getränke", icon:"Juice_Orange.png",     ekPrice:3 },
  { id:"slushy_aqua",      name:"Slush Aqua",         price:20, cat:"Getränke", icon:"slushy_aqua.png",      ekPrice:8 },
  { id:"slushy_atom",      name:"Slush Atom",         price:20, cat:"Getränke", icon:"slushy_atom.png",      ekPrice:8 },
  { id:"electrolyte_drink",name:"Elektrolyte Trink",  price:18, cat:"Getränke", icon:"electrolytet_rink.png",ekPrice:7 },
